...
class OsmApi:
    ...
    def Map(self, TileCoordinates, TileSource):
        """
        ...
        if   TileSource == 'Local':
            print(os.path.join(os.path.abspath(''), 'Data', 'Osm', TileCoordinates[0] + ',' + TileCoordinates[1] + ',' + TileCoordinates[2] + ',' + TileCoordinates[3] + '.osm'))
            data = os.path.join(os.path.abspath(''), 'Data', 'Osm', TileCoordinates[0] + ',' + TileCoordinates[1] + ',' + TileCoordinates[2] + ',' + TileCoordinates[3] + '.osm')
        
        elif TileSource == 'Internet':
            
            min_lon = float(TileCoordinates[0])
            min_lat = float(TileCoordinates[1])
            max_lon = float(TileCoordinates[2])
            max_lat = float(TileCoordinates[3])
